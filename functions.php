...
function trust_theme_enqueue_assets() {
  wp_enqueue_style('trust-theme-style', get_template_directory_uri(), array(), wp_get_theme()->get('Version'));
  wp_enqueue_script('trust-theme-script', get_template_directory_uri() . '/assets/js/main.js', array(), wp_get_theme()->get('Version'), false);
}
