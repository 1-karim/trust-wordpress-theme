...
?>
<section
  class="relative h-[70vh] w-full overflow-hidden dark:bg-[#141414]  bg-[#e0e2db] text-[#141414]  dark:text-[#e0e2db] transition-colors duration-300 ">
  <div
    ...
    <span class="h-1.5 bg-[#141414]  dark:bg-[#e0e2db] header-line">&nbsp;</span>
