...
get_header();
?>
<section class="relative h-[70vh] w-full overflow-hidden bg-[#e0e2db] text-[#141414] dark:bg-[#141414] dark:text-[#e0e2db] red:text-[#ff0000] transition-colors duration-300">
  <div
